...
LRS_PATH = "/Users/mpham26/Library/Mobile Documents/com~apple~CloudDocs/Documents/Research/laughing-umbrella/xx_synthesis_crerar/monodromy/lrslib-071b/lrs"
...
def check_for_lrs():
    ...
    """
    try:
        proc = Popen([LRS_PATH], stdin=PIPE, stdout=PIPE, stderr=PIPE, shell = True)
        proc.communicate(b"")
        return True
